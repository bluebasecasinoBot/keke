...
__SYD.navBar = () =>{
    return __c(
        "nav",
        {
            style:`overflow-y:hidden;min-height:90px;max-height:${__p(["navBar" , "mobileNavExpand"], false) ? "500px" : "90px"};width:90%;position:fixed;top:30px;left:50%;transform:translateX(-50%);border-radius:15px;padding:0 ${__p(["navBar" , "mobilePadState"], false) ? "10px" : "50px"};background: transparent;transition:all ease-out .4s;display:flex;align-items:flex-start;z-index:999;`
        },
        [
            __SYD.navLogo(),
...
__SYD.navLogo = () =>{
    return __c(
        "a",
        {
            style:`min-height:70px;min-width:70px;position:absolute;top:10px;left:${__p(["navBar" , "mobilePadState"], false) ? "10px" : "10px"};background-image:url("./assets/navLogo.png");border-radius:50%;border:3px ridge #4d8f00;`,
            href:"#"
...
__SYD.mobileMenuLogo = () =>{
    return __c(
        "div",
        {
            style:`height:40px;width:60px;position:absolute;top:21px;right:${__p(["navBar" , "mobilePadState"], false) ? "10px" : "50px"};background-color:#ffa500;border:1px solid #171717;border-radius:5px;display:${__p(["navBar" , "desktopMode"],true) ? "none" : "block"};cursor:pointer;background-image:url(./assets/menu.png);background-size:45%;`
        },[],
        {
            genericStyle:['bg_cover'],
            events:{
