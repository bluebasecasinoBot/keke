...
__SYD.footer_main_parent = () =>{
    ...
    return __c(
        'div',
        {
            style:`height:fit-content;padding:${check ? "20px 50px" : "20px 10px"};padding-bottom:20px;background:${" transparent "};width:100%;display:flex;flex-direction:column;row-gap:40px;align-items:center;`,
            id:"footer"
        },
        [
            __c(
                'div',
                {
                    style:'display:flex;flex-direction:column;column-gap:30px;flex-wrap:wrap;row-gap:30px;width:100%;max-width:1000px;height:fit-content;justify-content:center;align-items:flex-start;background:transparent;border-radius:20px;padding:20px 0px;'
                },
                [
                    ...
                    __c(
                        "a",
                        {
                            style:"font-size:14px;font-weight:300;align-self:center;color:#ffffff;text-decoration:underline;",
                            href:`${location.href}`
                        },
                        [
...
__SYD.footer_main_child2 = () =>{
    return __c(
        ...
        [
            __SYD.text_lib_type_h1_glob({cnt:'Socials' , size:'20px' , w:'700' , inject:'text-decoration:underline;width:100%;text-align:center;',clr:'#ffffff'}),
            __c(
                'div',
                {
                ...
                [
                    __c(
                        'div',
                        {
                            style:'height:fit-content;width:100%;display:flex;flex-direction:row;row-gap:20px;justify-content:space-between;'
                        },[
                            __c(
                                'div',
                                ...
                                [
                                    ...
                                    __c('a',{href:"https://x.com/keke_ethereum"},[__SYD.text_lib_type_p_glob_vmax({cnt:'Twitter', size:'14px' , w:'500',clr:'#ffffff'})]),
                                ]
                            ),
                            ...
                            __c(
                                ...
                                [
                                    ...
                                    __c('a',{href:"https://t.me/kekethefrog_Erc20"},[__SYD.text_lib_type_p_glob_vmax({cnt:'Telegram', size:'14px' , w:'500',clr:'#ffffff'})]),
                                ]
                            ),
                        ]
                    )
